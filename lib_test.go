			...
			Invoices: []payment_plan.Invoice{
				{
					...
					DueDate:           time.Date(2025, 05, 5, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
					MainIofTac:        7812.3757599999999001738615334,
					DebitService:      184.424239999999997507984517142,
				},
			},
		},
		{
					...
					Invoices: []payment_plan.Invoice{
						{
							...
							AccumulatedFactor: 0.981371965896169,
							DueDate:           time.Date(2025, 6, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        7810.44158499999957712134346366,
							DebitService:      184.378415000000018153514247388,
						},
					},
				},
				{
					...
					Invoices: []payment_plan.Invoice{
						{
							...
							AccumulatedFactor: 0.981371965896169,
							DueDate:           time.Date(2025, 6, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        3864.27128500000026178895495832,
							DebitService:      184.608714999999989458956406452,
						},
						{
							AccumulatedDays:   55,
							Factor:            0.958839243657051,
							AccumulatedFactor: 1.94021120955322,
							DueDate:           time.Date(2025, 7, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        3955.08166019750024133827537298,
							DebitService:      93.7983398024999814879265613854,
						},
					},
				},
				{
					...
					Invoices: []payment_plan.Invoice{
						{
							...
							AccumulatedFactor: 0.981371965896169,
							DueDate:           time.Date(2025, 6, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        2550.19876500000009400537237525,
							DebitService:      184.851235000000002628439688124,
						},
						{
							AccumulatedDays:   55,
							Factor:            0.958839243657051,
							AccumulatedFactor: 1.94021120955322,
							DueDate:           time.Date(2025, 7, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        2610.12843597749997570645064116,
							DebitService:      124.921564022500007240523700602,
						},
						{
							AccumulatedDays:   87,
							...
							DueDate:           time.Date(2025, 8, 4, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        2671.46645422297160621383227408,
							DebitService:      63.5835457770287533207920205314,
						},
					},
				},
				{
					...
					Invoices: []payment_plan.Invoice{
						{
							...
							AccumulatedFactor: 0.981371965896169,
							DueDate:           time.Date(2025, 6, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        1893.44906500000001869921106845,
							DebitService:      185.090935000000001764419721439,
						},
						{
							AccumulatedDays:   55,
							Factor:            0.958839243657051,
							AccumulatedFactor: 1.94021120955322,
							DueDate:           time.Date(2025, 7, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        1937.94511802750002971151843667,
							DebitService:      140.594881972500019173821783625,
						},
						{
							AccumulatedDays:   87,
							Factor:            0.935788233217493,
							AccumulatedFactor: 2.875999442770713,
							DueDate:           time.Date(2025, 8, 4, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        1983.48682830114626085560303181,
							DebitService:      95.0531716988537596080277580768,
						},
						{
							AccumulatedDays:   117,
							...
							DueDate:           time.Date(2025, 9, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        2030.09876876622320196474902332,
							DebitService:      48.4412312337768113934544089716,
						},
					},
				},
			},
					...
					Invoices: []payment_plan.Invoice{
						{
							...
							AccumulatedFactor: 0.981371965896169,
							DueDate:           time.Date(2025, 7, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        7809.80662500000016734702512622,
							DebitService:      184.363374999999990677679306827,
						},
					},
				},
				{
					...
					Invoices: []payment_plan.Invoice{
						{
							...
							AccumulatedFactor: 0.981371965896169,
							DueDate:           time.Date(2025, 7, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        3866.48152000000027328496798873,
							DebitService:      184.608480000000014342731446959,
						},
						{
							AccumulatedDays:   56,
							...
							DueDate:           time.Date(2025, 8, 4, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        3957.34383572000024287262931466,
							DebitService:      93.7461642800000021225059754215,
						},
					},
				},
				{
					...
					Invoices: []payment_plan.Invoice{
						{
							...
							AccumulatedFactor: 0.981371965896169,
							DueDate:           time.Date(2025, 7, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        2552.12393499999961932189762592,
							DebitService:      184.846065000000010059011401609,
						},
						{
							AccumulatedDays:   56,
							Factor:            0.957779256710963,
							AccumulatedFactor: 1.9391512226071321,
							DueDate:           time.Date(2025, 8, 4, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        2612.09884747249998326878994703,
							DebitService:      124.871152527500001383486960549,
						},
						{
							AccumulatedDays:   86,
							...
							DueDate:           time.Date(2025, 9, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        2673.48317038810364465462043881,
							DebitService:      63.4868296118962618379555351567,
						},
					},
				},
				{
					...
					Invoices: []payment_plan.Invoice{
						{
							...
							AccumulatedFactor: 0.981371965896169,
							DueDate:           time.Date(2025, 7, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        1895.07658499999979540007188916,
							DebitService:      185.083415000000002237356966361,
						},
						{
							AccumulatedDays:   56,
							Factor:            0.957779256710963,
							AccumulatedFactor: 1.9391512226071321,
							DueDate:           time.Date(2025, 8, 4, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        1939.61088474749976739985868335,
							DebitService:      140.549115252500001815860741772,
						},
						{
							AccumulatedDays:   86,
							Factor:            0.93475372892694,
							AccumulatedFactor: 2.873904951534072,
							DueDate:           time.Date(2025, 9, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        1985.19174053906613153230864555,
							DebitService:      94.9682594609337655811032163911,
						},
						{
							AccumulatedDays:   116,
							...
							DueDate:           time.Date(2025, 10, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        2031.84374644173408341885078698,
							DebitService:      48.3162535582657213240054261405,
						},
					},
				},
			},
					...
					Invoices: []payment_plan.Invoice{
						{
							...
							DueDate:           time.Date(2025, 8, 4, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        7819.94607499999983701854944229,
							DebitService:      184.393924999999995861799106933,
						},
					},
				},
				{
					...
					Invoices: []payment_plan.Invoice{
						{
							...
							AccumulatedFactor: 0.980287069256833,
							DueDate:           time.Date(2025, 8, 4, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        3871.29601000000002386514097452,
							DebitService:      184.623989999999992051016306505,
						},
						{
							AccumulatedDays:   56,
							...
							DueDate:           time.Date(2025, 9, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        3962.2714662349999343859963119,
							DebitService:      93.6485337649999962650326779112,
						},
					},
				},
				{
					...
					Invoices: []payment_plan.Invoice{
						{
							...
							AccumulatedFactor: 0.980287069256833,
							DueDate:           time.Date(2025, 8, 4, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        2555.3033599999998841667547822,
							DebitService:      184.856639999999998735802364536,
						},
						{
							AccumulatedDays:   56,
							Factor:            0.956720441569568,
							AccumulatedFactor: 1.937007510826401,
							DueDate:           time.Date(2025, 9, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        2615.35298895999994783778674901,
							DebitService:      124.807011039999991908189258538,
						},
						{
							AccumulatedDays:   86,
							...
							DueDate:           time.Date(2025, 10, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        2676.81378420055989408865571022,
							DebitService:      63.3462157994399959193287941162,
						},
					},
				},
				{
					...
					Invoices: []payment_plan.Invoice{
						{
							...
							AccumulatedFactor: 0.980287069256833,
							DueDate:           time.Date(2025, 8, 4, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        1896.95413000000007741618901491,
							DebitService:      185.095869999999990795913618058,
						},
						{
							AccumulatedDays:   56,
							Factor:            0.956720441569568,
							AccumulatedFactor: 1.937007510826401,
							DueDate:           time.Date(2025, 9, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        1941.53255205500022384512703866,
							DebitService:      140.517447944999986475522746332,
						},
						{
							AccumulatedDays:   86,
							Factor:            0.933720368270266,
							AccumulatedFactor: 2.870727879096667,
							DueDate:           time.Date(2025, 10, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        1987.15856702829273672250565141,
							DebitService:      94.8914329717074878089988487773,
						},
						{
							AccumulatedDays:   117,
							Factor:            0.912281747198563,
							...
							DueDate:           time.Date(2025, 11, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        2033.85679335345753315777983516,
							DebitService:      48.1932066465426061085963738151,
						},
					},
				},
			},
					...
					Invoices: []payment_plan.Invoice{
						{
							...
							AccumulatedFactor: 0.981371965896169,
							DueDate:           time.Date(2025, 9, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        7809.1518999999998413841240108,
							DebitService:      184.348100000000016507328837179,
						},
					},
				},
				{
					...
					Invoices: []payment_plan.Invoice{
						{
							...
							AccumulatedFactor: 0.981371965896169,
							DueDate:           time.Date(2025, 9, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        3865.85183499999993728124536574,
							DebitService:      184.57816500000001269654603675,
						},
						{
							AccumulatedDays:   53,
							Factor:            0.957779256710963,
							AccumulatedFactor: 1.9391512226071321,
							DueDate:           time.Date(2025, 10, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        3956.69935312249981507193297148,
							DebitService:      93.7306468775000070081659941934,
						},
					},
				},
				{
					...
					Invoices: []payment_plan.Invoice{
						{
							...
							AccumulatedFactor: 0.981371965896169,
							DueDate:           time.Date(2025, 9, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        2550.72424999999975625541992486,
							DebitService:      184.8157500000000084128259914,
						},
						{
							AccumulatedDays:   53,
							Factor:            0.957779256710963,
							AccumulatedFactor: 1.9391512226071321,
							DueDate:           time.Date(2025, 10, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        2610.66626987500012546661309898,
							DebitService:      124.87373012500002289471012773,
						},
						{
							AccumulatedDays:   84,
							Factor:            0.935788233217493,
							...
							DueDate:           time.Date(2025, 11, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        2672.01692721706240263301879168,
							DebitService:      63.5230727829375112492016342003,
						},
					},
				},
				{
					...
					Invoices: []payment_plan.Invoice{
						{
							...
							AccumulatedFactor: 0.981371965896169,
							DueDate:           time.Date(2025, 9, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        1893.09666500000002997694537044,
							DebitService:      185.053335000000004129105946049,
						},
						{
							AccumulatedDays:   53,
							Factor:            0.957779256710963,
							AccumulatedFactor: 1.9391512226071321,
							DueDate:           time.Date(2025, 10, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        1937.58443662750005387351848185,
							DebitService:      140.565563372499980232532834634,
						},
						{
							AccumulatedDays:   84,
							Factor:            0.935788233217493,
							AccumulatedFactor: 2.874939455824625,
							DueDate:           time.Date(2025, 11, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        1983.11767088824626625864766538,
							DebitService:      95.0323291117537394256942206994,
						},
						{
							AccumulatedDays:   114,
							Factor:            0.914302133077605,
							...
							DueDate:           time.Date(2025, 12, 3, 7, 0, 0, 0, time.FixedZone("-03", -3*60*60)),
							MainIofTac:        2029.72093615412018152710516006,
							DebitService:      48.4290638458799520549291628413,
						},
					},
				},
			},
...
func helperAssert(r payment_plan.Response, e payment_plan.Response, i int, t *testing.T) {
	...
	if len(invoicesExpected) != len(invoicesActual) {
		...
		for j, invoice := range invoicesExpected {
			...
			//Round the mainIofTac to 10 decimal places for comparison
			actualMainIofTac, _ := strconv.ParseFloat(fmt.Sprintf("%.10f", invoice.MainIofTac), 64)
			expectedMainIofTac, _ := strconv.ParseFloat(fmt.Sprintf("%.10f", invoicesActual[j].MainIofTac), 64)
			if actualMainIofTac != expectedMainIofTac {
				t.Errorf("Installment %d, Invoice %d: Expected MainIofTac %.30g, got %.30g", i+1, j+1, invoice.MainIofTac, invoicesActual[j].MainIofTac)
			}

			//Round the debitService to 10 decimal places for comparison
			actualDebitService, _ := strconv.ParseFloat(fmt.Sprintf("%.10f", invoice.DebitService), 64)
			expectedDebitService, _ := strconv.ParseFloat(fmt.Sprintf("%.10f", invoicesActual[j].DebitService), 64)
			if actualDebitService != expectedDebitService {
				t.Errorf("Installment %d, Invoice %d: Expected DebitService %.30g, got %.30g", i+1, j+1, invoice.DebitService, invoicesActual[j].DebitService)
			}
		}
	}
}
